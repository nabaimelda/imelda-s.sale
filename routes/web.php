...
Route::post('/manage-pulsa-create',[PulsaController::class, 'create'])->name('pulsa-store');
...
Route::get('/barang-barang-create', [BarangController::class, 'create'])->name('barang-create');
Route::post('/barang-barang-create', [BarangController::class, 'create'])->name('barang-store');
Route::get('/barang-barang-edit/{id}', [BarangController::class, 'edit'])->name('barang-edit');
